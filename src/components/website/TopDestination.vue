...
<template>
  <section class="px-4 md:px-10 lg:px-10 bg-white mb-10 mt-5 sm:pb-10">
    <div class="max-w-7xl mx-auto">
      ...
      <div
        ref="carousel"
        class="flex overflow-x-auto scroll-smooth no-scrollbar gap-0 mt-4"
      >
        <div
          v-for="(img, i) in images"
          :key="i"
          class="w-full md:w-1/4 flex-shrink-0 px-1"
        >
          <img
            :src="img"
            class="w-full h-auto rounded-lg border-4 border-[#f3f1f1]"
          />
        </div>
      </div>
    </div>
