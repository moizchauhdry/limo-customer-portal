<template>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-5 md:gap-16">
      ...
      <div class="order-1 lg:order-none" data-aos="fade-right" data-aos-duration="1200" data-aos-offset="150"
        ...
        <p class="mt-2 text-sm md:text-base lg:text-lg text-[#626262] font-medium text-center sm:text-start">
          Since 2008, RentRide Has Been Providing Exceptional Car Rental Services To Customers Worldwide. We Pride
          Ourselves On Offering A Premium Fleet Of Vehicles, Outstanding Customer Service, And Competitive Pricing.
        </p>
        <button
          class="flex mx-auto sm:mx-0 mt-6 w-max font-semibold px-12 py-2 rounded-lg hover:opacity-90 transition-opacity bg-[linear-gradient(93.72deg,#FAB707_2.95%,#FCDA19_100%)] text-[#010101]">
  ...
  <section class="px-4 py-6 sm:py-16 md:px-10 bg-[#FFFFFF]">
    ...
    data-aos-delay="100">
        ...
        <button
          class="flex mx-auto sm:mx-0 mt-6 w-max bg-[linear-gradient(93.72deg,#FAB707_2.95%,#FCDA19_100%)] text-[#010101] font-semibold px-12 py-3 rounded-lg hover:opacity-90 transition-opacity mb-10 sm:mb-0">
          Browse luxury sedans
        </button>
      </div>
    </div>
